...
curl https://raw.githubusercontent.com/choreonoid/choreonoid/master/misc/script/install-requisites-ubuntu-$VERSION_ID.sh >  ./choreonoid/misc/script/install-requisites-ubuntu-$VERSION_ID.sh || echo 'Fetching has been skipped since not found.'
